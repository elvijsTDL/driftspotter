...
export const participationBadge = (p: "drive" | "watch" | "both") => {
        ...
        <div className="p-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="relative z-20 flex items-center gap-1.5">
              <button
                onClick={handleShare}
                className="w-8 h-8 rounded-lg flex items-center justify-center border border-border-light text-muted hover:border-drift-orange hover:text-drift-orange transition-all active:scale-95"
